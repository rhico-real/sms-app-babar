...
class _$LoginModelCopyWithImpl<$Res, $Val extends LoginModel>
  ...
  @override
  $Res call({Object? status = freezed, Object? detail = freezed}) {
    return _then(
      _value.copyWith(
            status:
                freezed == status
...
class _$LoginModelImpl implements _LoginModel {
  const _$LoginModelImpl({this.status, this.detail});
  ...
  @override
  String toString() {
    return 'LoginModel(status: $status, detail: $detail)';
  }
...
abstract class _LoginModel implements LoginModel {
  const factory _LoginModel({final String? status, final String? detail}) =
      _$LoginModelImpl;
